...
- **Compensation in public copy (updated Sept 2026):** the open **Apprentice Gardener** role publishes **"$20–$22/hr to start"**, that it's a four-year paid apprenticeship with **scheduled annual raises**, and that promotion to Gardener typically happens in three to four years. Upper rungs (Gardener, Head Gardener) stay qualitative — no dollar figures for those levels, no cap figures.
...
- **Benefits in public copy (updated Sept 2026):** specific, itemized, and public from day one — PTO increasing with tenure (no day counts or percentages), tools/equipment/safety gear provided, named paid certifications (pesticide applicator license, arborist coursework, native plant identification, safety certifications), mileage reimbursement for personal-vehicle use between sites. Profit sharing is not mentioned in public copy at all — that line was removed, not replaced with a vaguer one.
